...
//        dd($request->all());
        ...
        $hotels->description_en = $request->description_en;
         $hotels->description_fr = $request->description_fr;
