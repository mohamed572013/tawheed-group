        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">تعديل بيانات سلايدر</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{!! url('admin/sliders/update/'.$id) !!}" id="slider_form" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group  margin-top-20">
                            <label class="control-label col-md-2">العنوان بالعربية
                                <span class="required"> * </span>
                            </label>
                            <div class="col-md-9">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="title_ar" value="{{ $edit->title_ar }}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            <label class="control-label col-md-2">العنوان بالإنجليزية
                                <span class="required"> * </span>
                            </label>
                            <div class="col-md-9">
                                <div class="input-icon right">
                        ...
                        <div class="form-group  margin-top-20">
                            <label class="control-label col-md-2">العنوان بالفرنسية
                                <span class="required"> * </span>
                            </label>
                            <div class="col-md-9">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="title_fr" value="{{ $edit->title_fr }}" />
                                </div>
                            </div>
                        </div>
                        
                        <div class="form-group  margin-top-20">
                            <label class="control-label col-md-2">العنوان بالأردية
                                <span class="required"> * </span>
                            </label>
                            <div class="col-md-9">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="title_ur" value="{{ $edit->title_ur }}" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="url" value="{{ $edit->url }}" /> </div>
                                <span class="help-block"> e.g: http://www.demo.com or http://demo.com </span>
                            </div>
                        </div>
                        <div class="form-group ">
                            <label class="control-label col-md-2"> صورة الخلفية  <span class="required"> * </span></label>
                            <div class="col-md-9">
...
@stop
@section('scripts')
{!! HTML::script('assets/pages/scripts/validation/slider.js') !!}
@stop
