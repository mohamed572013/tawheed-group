        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">تعديل رأي عميل</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{!! url('admin/reviews/update/'.$id) !!}" id="review_form" method="post" class="form-horizontal" enctype="multipart/form-data">
