        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">إضافة ميزة جديدة</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{!! url('admin/features/store') !!}" id="feature_form" method="post" class="form-horizontal" enctype="multipart/form-data">
