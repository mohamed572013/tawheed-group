...
<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal form-row-seperated" method="post" action="{!! url('admin/services/store') !!}" enctype="multipart/form-data" id="service_form">
...
{!! HTML::script('assets/pages/scripts/validation/service.js') !!}
