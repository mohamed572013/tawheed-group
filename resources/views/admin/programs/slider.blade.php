@extends('admin.app')
@section('title', ' | إضافة صور للبرنامج')
@section('styles')
        ...
        <div class="portlet light portlet-fit bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">سلايدر برنامج</span>
                </div>
            </div>
            <div class="portlet-body">
                <form action="{!! url('admin/programs/store_slider') !!}" id="program_form" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" value="{{ $id }}" name="program_id" />
                    <input type="hidden" value="slider" id="form_type" />
                    <div class="form-body">
                                ...
                                <div class="mt-card-avatar mt-overlay-1">
                                    ...
                                    <div class="mt-overlay">
                                        <ul class="mt-info">
                                            ...
                                            <li>
                                                <a  data-id="{!! $one->id !!}"   class="btn default btn-outline delete_link" href="{!! url('/admin/programs/deleteslider/'.$one->id) !!}">
