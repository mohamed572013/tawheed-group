    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            ...
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{!! url('admin/hotels/update_room/'.$id) !!}" id="hotel_form" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" value="edit_room" id="form_type" />
                    <input type="hidden" value="{{ $edit->room_id }}" id="room_id" />
                    <input type="hidden" value="{{ $edit->meal_id }}" id="meal_id" />
                    <input type="hidden" value="{{ $edit->currency_id }}" id="currency_id" />
                    <input type="hidden" name="hotel_id" value="{{ $edit->hotel_id }}" id="hotel_id" />
                    <div class="form-body">
                        ...
                        <div class="form-group margin-top-20">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input name="start_date" value="{{ $edit->start_date }}" class="form-control datetime" id="start_date" type="date" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group margin-top-20">
                            ...
                            <div class="col-md-3">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input name="end_date"  value="{{ $edit->end_date }}"  class="form-control datetime" id="end_date" type="date" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group  margin-top-20">
