@extends('admin.app')
@section('title', ' | إضافة صور للفندق')
@section('styles')
        ...
        <div class="portlet light portlet-fit bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">سلايدر فندق</span>
                </div>
            </div>
            <div class="portlet-body">
                <form action="{!! url('admin/hotels/store_slider') !!}" id="hotel_slider_form" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="mt-card-avatar mt-overlay-1">
                                    ...
                                    <div class="mt-overlay">
                                        <ul class="mt-info">
                                            ...
                                            <li>
                                                <a  data-id="{!! $one->id !!}"   class="btn default btn-outline delete_link" href="{!! url('/admin/hotels/deleteslider/'.$one->id) !!}">
