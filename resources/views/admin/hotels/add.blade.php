...
<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal form-row-seperated" method="post" action="{!! url('admin/hotels/store') !!}" enctype="multipart/form-data" id="hotel_form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" class="form-control" name="title_fr" placeholder="">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <textarea class="form-control" rows='5' name="keywords_fr"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <div class="form-group  margin-top-20">
                ...
                <div class="col-md-9">
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" name="distance_from_the_haram" />
                    </div>
                </div>
            </div>
            <div class="form-group  margin-top-20">
            ...
            <div class="form-group  margin-top-20" id="city_block" style="display: none;">
