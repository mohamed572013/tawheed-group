...
<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal form-row-seperated" method="post" action="{!! url('admin/news/update/'.$id) !!}" enctype="multipart/form-data" id="news_form">
...
{!! HTML::script('assets/pages/scripts/validation/news.js') !!}
