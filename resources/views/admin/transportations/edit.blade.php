@extends('admin.app')
@section('title', ' | تعديل وسيلة مواصلات')
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">تعديل بيانات وسيلة مواصلات</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{!! url('admin/transportations/update/'.$id) !!}" id="transportation_form" method="post" class="form-horizontal" enctype="multipart/form-data">
