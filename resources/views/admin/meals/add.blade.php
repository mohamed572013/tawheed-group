        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">إضافة وجبة</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{!! url('admin/meals/store') !!}" id="meal_form" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group  margin-top-20">
                         ...
                         <div class="form-group  margin-top-20">
                            <label class="control-label col-md-2">الإسم بالفرنسة
                                <span class="required"> * </span>
                            </label>
                            <div class="col-md-9">
                                <div class="input-icon right">
