@extends('admin.app')
@section('title', ' | إضافة لمعرض الصور')
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">إضافة لمعرض الصور</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{!! url('admin/gallery/store') !!}" id="gallery_form" method="post" class="form-horizontal" enctype="multipart/form-data">
