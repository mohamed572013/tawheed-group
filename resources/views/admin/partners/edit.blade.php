        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">تعديل بيانات شريك</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{!! url('admin/partners/update/'.$id) !!}" id="partner_form" method="post" class="form-horizontal" enctype="multipart/form-data">
...
@stop
@section('scripts')
{!! HTML::script('assets/pages/scripts/validation/partner.js') !!}
@stop
