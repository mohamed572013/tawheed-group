        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> عروض خاصة </span>
                </div>
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{!! url('/admin/special/add') !!}" class="btn sbold green" id="sample_1_new">
                                    إضافة جديد
                ...
                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX tr_{{ $one->id }}">
                            ...
                            <td> @if($one->active == 0) غير مفعل @else مفعل @endif </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        <li>
                                            <a href="{!! url('/admin/special/edit/'.$one->id) !!}">
                                                <i class="icon-docs"></i> تعديل </a>
                                        </li>
                                        <li>
                                            <a class="delete_link" data-id="{!! $one->id !!}" href="{!! url('/admin/special/delete/'.$one->id) !!}">
