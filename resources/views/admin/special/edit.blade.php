        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">تعديل عرض خاص</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{!! url('admin/special/update/'.$id) !!}" id="special_form" method="post" class="form-horizontal" enctype="multipart/form-data">
                    <input type="hidden" value="edit" id="form_type" />
                    <input type="hidden" value="{{ $edit->active }}" id="active" />
