@extends('admin.app')
@section('title', ' | إضافة سعر لبرنامج')
        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">إضافة سعر لبرنامج</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{!! url('admin/programdates/store/'.$program_id) !!}" id="programdate_form" method="post" class="form-horizontal" enctype="multipart/form-data">
