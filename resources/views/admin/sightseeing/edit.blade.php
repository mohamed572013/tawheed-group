@extends('admin.app')
@section('title', ' | تعديل بيانات مزار')
...
<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal form-row-seperated" method="post" action="{!! url('admin/sightseeing/update/'.$id) !!}" enctype="multipart/form-data" id="sightseeing_form">
